...
<div class="hello">
    <h1><u>Sum Calculator</u></h1>
</div>
<div class="cal">
<label>Enter first number</label><br>
      <input type ="number" v-model="number1" placeholder="Enter Numbers" /><br><br>
<label>Enter second number</label><br>
      <input type ="number" v-model="number2" placeholder="Enter Numbers" /><br><br>
      <button v-on:click="sum">Sum</button> |
      <button v-on:click="subs">Substract</button> |
      <button v-on:click="product">Multiply</button> |
...
export default {
  ...
  methods:{
      sum(){
       return this.x = this.number1 + this.number2;  
      },
      subs(){
        return this.x =  this.number1 - this.number2;  
      },
