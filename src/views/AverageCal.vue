...
<nav
    ...
    <h1><u>Average Calculator</u></h1>
<div class="cal">
<label>Enter Numbers without space & comma</label><br>
      <input type ="text" v-model="number" placeholder="Enter Numbers" /><br><br>
...
export default {
  ...
  methods:{
      click(){
  this.arr = Array.from(String(this.number), Number);
  this.result=this.arr.reduce((a, b) => a + b, 0)
   return this.res=this.result/this.arr.length
